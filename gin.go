...
// 签名及验证的中间件
func SignatureMiddleware(signerGetter func(ctx *gin.Context) Signer, signRule func(mp map[string]string) []byte) gin.HandlerFunc {
	return func(c *gin.Context) {
		if signRule == nil {
...
// 加解密内容的中间件
func CryptoMiddleware(cryptorGetter func(ctx *gin.Context) Cryptor) gin.HandlerFunc {
	return func(c *gin.Context) {
