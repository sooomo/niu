...
func NewMsgPackProtocol(signer crypto.Signer, cryptor crypto.Cryptor) *DefaultMessageProtocol {
...
func NewJsonProtocol(signer crypto.Signer, cryptor crypto.Cryptor) *DefaultMessageProtocol {
	return &DefaultMessageProtocol{
		signer:    signer,
		cryptor:   cryptor,
